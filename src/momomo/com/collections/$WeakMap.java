 ...
 * ///// mmm:modified 
 * /////////////////////////////////////////////////////////////////////
 * Not used anymore opting for Guava CacheBuilder.weakKeys().weakValues() instead
 *
 * Pulled in by Joseph S.
 *
 * @See
 * https://github.com/apache/cxf/blob/master/core/src/main/java/org/apache/cxf/common/util/WeakIdentityHashMap.java
 * https://github.com/twall/jna/blob/master/src/com/sun/jna/WeakIdentityHashMap.java
 *
 * There are at least three - four different implementations of WeakIdentityHashmap.
 *
 * This one, ie: hibernates provides a top to toe approach including the on the Entries
 * /////////////////////////////////////////////////////////////////////
 * 
 * @author Joseph S.
 */
public class $WeakMap<K,V> /*extends AbstractMap*/ implements Map<K,V> {
    ...
    private static class Entry<K,V> extends WeakReference<K> implements Map.Entry<K,V> {
        ...
        @Override
        public K getKey() {
            return $WeakMap.unmaskNull( this.get() );
        }
    ...
    private abstract class HashIterator<E> implements Iterator<E> {
        ...
        public void remove() {
            ...
            $WeakMap.this.remove( currentKey );
