...
public final class HtmlDecoder {
    ...
    private final HtmlChars characterEntityReferences;
    ...
    public HtmlDecoder(HtmlChars characterEntityReferences, String original) {
    ...
    private boolean processNamedReference() {
        ...
        if (mappedCharacter != HtmlChars.CHAR_NULL) {
